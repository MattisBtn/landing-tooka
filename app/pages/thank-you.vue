    ...
    <div class="min-h-screen flex flex-col relative overflow-hidden">
        ...
        <header class="absolute top-4 left-4 right-4 flex items-center justify-between">
            ...
            <motion.div class="flex items-center" :initial="{ opacity: 0, x: -20 }" :animate="{ opacity: 1, x: 0 }"
                ...
                <NuxtImg src="/images/logo-light.png" alt="Tooka" class="h-8 w-auto dark:hidden" />
                <NuxtImg src="/images/logo-dark.png" alt="Tooka" class="h-8 w-auto hidden dark:block" />
            </motion.div>
        ...
        <main id="main-content" class="flex-1 flex items-center justify-center px-4 py-6 md:py-8">
            <div class="max-w-2xl w-full text-center space-y-8 md:space-y-12">
                ...
                <motion.div class="pt-6 md:pt-8" :initial="{ opacity: 0 }" :animate="{ opacity: 1 }"
                    ...
                    <WaitlistCounter :initial-count="124" />
                </motion.div>

                <!-- Social Proof -->
                <motion.div class="pt-2 md:pt-4" :initial="{ opacity: 0 }" :animate="{ opacity: 1 }"
                    :transition="{ duration: 0.8, delay: 1.2, ease: 'easeOut' }">
                    <SocialSection :is-loading="false" :animation-delay="0" />
                </motion.div>
            </div>
        </main>
...
useSeoMeta({
    title: 'Merci ! - Tooka',
    description: 'Merci de vous être inscrit à notre liste d\'attente. Vous serez parmi les premiers à découvrir Tooka !',
